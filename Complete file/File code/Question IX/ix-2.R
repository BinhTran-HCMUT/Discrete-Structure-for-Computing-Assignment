...
ggplot(brazil_2020_3,(aes(x=new_cases,y=new_deaths)))+geom_point(shape=1, color="blue")+facet_wrap( ~ month)+ggtitle("Bieu do tuong quan giua ca nhiem va tu vong thang 3/2020 cua Brazil") + geom_smooth()
print(cor(brazil_2020_3$new_cases,brazil_2020_3$new_deaths))

ggplot(brazil_2020_6,(aes(x=new_cases,y=new_deaths)))+geom_point(shape=1, color="blue")+facet_wrap( ~ month)+ggtitle("Bieu do tuong quan giua ca nhiem va tu vong thang 6/2020 cua Brazil") +  geom_smooth()
print(cor(brazil_2020_6$new_cases,brazil_2020_6$new_deaths)) 
...
ggplot(brazil_2021_3,(aes(x=new_cases,y=new_deaths)))+geom_point(shape=1, color="blue")+facet_wrap( ~ month)+ ggtitle("Bieu do tuong quan giua ca nhiem va tu vong thang 3/2021 cua Brazil")+ geom_smooth()
print(cor(brazil_2021_3$new_cases,brazil_2021_3$new_deaths)) 

ggplot(brazil_2021_6,(aes(x=new_cases,y=new_deaths)))+geom_point(shape=1, color="blue")+facet_wrap( ~ month)+ggtitle("Bieu do tuong quan giua ca nhiem va tu vong thang 6/2021 cua Brazil")+  geom_smooth()
print(cor(brazil_2021_6$new_cases,brazil_2021_6$new_deaths)) 
...
ggplot(chile_2020_3,(aes(x=new_cases,y=new_deaths)))+geom_point(shape=1, color="blue")+facet_wrap( ~ month)+ggtitle("Bieu do tuong quan giua ca nhiem va tu vong thang 3/2020 cua Chile") + geom_smooth()
print(cor(chile_2020_3$new_cases,chile_2020_3$new_deaths))

ggplot(chile_2020_6,(aes(x=new_cases,y=new_deaths)))+geom_point(shape=1, color="blue")+facet_wrap( ~ month)+ggtitle("Bieu do tuong quan giua ca nhiem va tu vong thang 6/2020 cua Chile") +  geom_smooth()
print(cor(chile_2020_6$new_cases,chile_2020_6$new_deaths)) 
...
ggplot(chile_2021_3,(aes(x=new_cases,y=new_deaths)))+geom_point(shape=1, color="blue")+facet_wrap( ~ month)+ ggtitle("Bieu do tuong quan giua ca nhiem va tu vong thang 3/2021 cua Chile")+ geom_smooth()
print(cor(chile_2021_3$new_cases,chile_2021_3$new_deaths)) 

ggplot(chile_2021_6,(aes(x=new_cases,y=new_deaths)))+geom_point(shape=1, color="blue")+facet_wrap( ~ month)+ggtitle("Bieu do tuong quan giua ca nhiem va tu vong thang 6/2021 cua Chile")+  geom_smooth()
print(cor(chile_2021_6$new_cases,chile_2021_6$new_deaths)) 
...
ggplot(venezuela_2020_3,(aes(x=new_cases,y=new_deaths)))+geom_point(shape=1, color="blue")+facet_wrap( ~ month)+ggtitle("Bieu do tuong quan giua ca nhiem va tu vong thang 3/2020 cua Venezuela") + geom_smooth()
print(cor(venezuela_2020_3$new_cases,venezuela_2020_3$new_deaths))

ggplot(venezuela_2020_6,(aes(x=new_cases,y=new_deaths)))+geom_point(shape=1, color="blue")+facet_wrap( ~ month)+ggtitle("Bieu do tuong quan giua ca nhiem va tu vong thang 6/2020 cua Venezuela") +  geom_smooth()
print(cor(venezuela_2020_6$new_cases,venezuela_2020_6$new_deaths)) 
...
ggplot(venezuela_2021_3,(aes(x=new_cases,y=new_deaths)))+geom_point(shape=1, color="blue")+facet_wrap( ~ month)+ ggtitle("Bieu do tuong quan giua ca nhiem va tu vong thang 3/2021 cua Venezuela")+ geom_smooth()
print(cor(venezuela_2021_3$new_cases,venezuela_2021_3$new_deaths)) 

ggplot(venezuela_2021_6,(aes(x=new_cases,y=new_deaths)))+geom_point(shape=1, color="blue")+facet_wrap( ~ month)+ggtitle("Bieu do tuong quan giua ca nhiem va tu vong thang 6/2021 cua Venezuela")+  geom_smooth()
print(cor(venezuela_2021_6$new_cases,venezuela_2021_6$new_deaths)) 
