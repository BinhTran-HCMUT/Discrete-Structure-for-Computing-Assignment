...
library(ggplot2)
ggplot()+geom_line(data=brazil_2020_3,(aes(x = dates, y = cases_tichluy,group=1,col="blue")))+geom_line(data=brazil_2020_6,(aes(x = dates, y = cases_tichluy,group=1,col="red"))) +geom_line(data=brazil_2020_7,(aes(x = dates, y = cases_tichluy,group=1,col="green")))+labs(title = "Bieu do the hien thu thap nhiem benh tich luy vao cac thang 03,06,07-2020 cua Brazil",subtitle = "Theo trung binh 7 ngay gan nhat",y = "So ca",x = "Ngay",color = "Chu thich")+scale_x_discrete(breaks=c("10","20","31"))+scale_color_manual(labels = c("thang 3", "thang 7","thang 6"), values= c( "blue","red", "green")) 
ggplot()+geom_line(data=brazil_2021_1,(aes(x = dates, y = cases_tichluy,group=1,col="blue")))+geom_line(data=brazil_2021_3,(aes(x = dates, y = cases_tichluy,group=1,col="red"))) +geom_line(data=brazil_2021_6,(aes(x = dates, y = cases_tichluy,group=1,col="green")))+geom_line(data=brazil_2021_7,(aes(x = dates, y = cases_tichluy,group=1,col="orange")))+labs(title = "Bieu do the hien thu thap nhiem benh tich luy vao cac thang 01,03,06,07-2021 cua Brazil",subtitle = "Theo trung binh 7 ngay gan nhat",y = "So ca",x = "Ngay",color = "Chu thich")+scale_x_discrete(breaks=c("10","20","31"))+scale_color_manual(labels = c("thang 1", "thang 6","thang 7","thang 3"), values= c( "blue","red", "green","orange")) 
ggplot()+geom_line(data=brazil_2022_1,(aes(x = dates, y = cases_tichluy,group=1,col="blue")))+labs(title = "Bieu do the hien thu thap nhiem benh tich luy vao cac thang 01-2022 cua Brazil",subtitle = "Theo trung binh 7 ngay gan nhat",y = "So ca",x = "Ngay",color = "Chu thich")+scale_x_discrete(breaks=c("10","20","31"))+scale_color_manual(labels = c("thang 1"), values= c( "blue")) 
...
library(ggplot2)
ggplot()+geom_line(data=chile_2020_3,(aes(x = dates, y = cases_tichluy,group=1,col="blue")))+geom_line(data=chile_2020_6,(aes(x = dates, y = cases_tichluy,group=1,col="red"))) +geom_line(data=chile_2020_7,(aes(x = dates, y = cases_tichluy,group=1,col="green")))+labs(title = "Bieu do the hien thu thap nhiem benh tich luy vao cac thang 03,06,07-2020 cua Chile",subtitle = "Theo trung binh 7 ngay gan nhat",y = "So ca",x = "Ngay",color = "Chu thich")+scale_x_discrete(breaks=c("10","20","31"))+scale_color_manual(labels = c("thang 3", "thang 6","thang 7"), values= c( "blue","red", "green")) 
ggplot()+geom_line(data=chile_2021_1,(aes(x = dates, y = cases_tichluy,group=1,col="blue")))+geom_line(data=chile_2021_3,(aes(x = dates, y = cases_tichluy,group=1,col="red"))) +geom_line(data=chile_2021_6,(aes(x = dates, y = cases_tichluy,group=1,col="green")))+geom_line(data=chile_2021_7,(aes(x = dates, y = cases_tichluy,group=1,col="orange")))+labs(title = "Bieu do the hien thu thap nhiem benh tich luy vao cac thang 01,03,06,07-2021 cua Chile",subtitle = "Theo trung binh 7 ngay gan nhat",y = "So ca",x = "Ngay",color = "Chu thich")+scale_x_discrete(breaks=c("10","20","31"))+scale_color_manual(labels = c("thang 1", "thang 6","thang 7","thang 3"), values= c( "blue","red", "green","orange")) 
ggplot()+geom_line(data=chile_2022_1,(aes(x = dates, y = cases_tichluy,group=1,col="blue")))+labs(title = "Bieu do the hien thu thap nhiem benh tich luy vao cac thang 01-2022 cua Chile",subtitle = "Theo trung binh 7 ngay gan nhat",y = "So ca",x = "Ngay",color = "Chu thich")+scale_x_discrete(breaks=c("10","20","31"))+scale_color_manual(labels = c("thang 1"), values= c( "blue"))
...
library(ggplot2)
ggplot()+geom_line(data=venezuela_2020_3,(aes(x = dates, y = cases_tichluy,group=1,col="blue")))+geom_line(data=venezuela_2020_6,(aes(x = dates, y = cases_tichluy,group=1,col="red"))) +geom_line(data=venezuela_2020_7,(aes(x = dates, y = cases_tichluy,group=1,col="green")))+labs(title = "Bieu do the hien thu thap nhiem benh tich luy vao cac thang 03,06,07-2020 cua Venezuela",subtitle = "Theo trung binh 7 ngay gan nhat",y = "So ca",x = "Ngay",color = "Chu thich")+scale_x_discrete(breaks=c("10","20","31"))+scale_color_manual(labels = c("thang 3", "thang 7","thang 6"), values= c( "blue","red", "green")) 
ggplot()+geom_line(data=venezuela_2021_1,(aes(x = dates, y = cases_tichluy,group=1,col="blue")))+geom_line(data=venezuela_2021_3,(aes(x = dates, y = cases_tichluy,group=1,col="red"))) +geom_line(data=venezuela_2021_6,(aes(x = dates, y = cases_tichluy,group=1,col="green")))+geom_line(data=venezuela_2021_7,(aes(x = dates, y = cases_tichluy,group=1,col="orange")))+labs(title = "Bieu do the hien thu thap nhiem benh tich luy vao cac thang 01,03,06,07-2021 cua Venezuela",subtitle = "Theo trung binh 7 ngay gan nhat",y = "So ca",x = "Ngay",color = "Chu thich")+scale_x_discrete(breaks=c("10","20","31"))+scale_color_manual(labels = c("thang 1", "thang 6","thang 7","thang 3"), values= c( "blue","red", "green","orange")) 
ggplot()+geom_line(data=venezuela_2022_1,(aes(x = dates, y = cases_tichluy,group=1,col="blue")))+labs(title = "Bieu do the hien thu thap nhiem benh tich luy vao cac thang 01-2022 cua Venezuela",subtitle = "Theo trung binh 7 ngay gan nhat",y = "So ca",x = "Ngay",color = "Chu thich")+scale_x_discrete(breaks=c("10","20","31"))+scale_color_manual(labels = c("thang 1"), values= c( "blue"))
