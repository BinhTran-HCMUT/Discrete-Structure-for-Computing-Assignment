...
library(ggplot2)
ggplot(chile_Made_2020,(aes(x = dates, y = new_cases_tb))) + geom_line(aes(color = month),group=1) +facet_wrap( ~ month)  +labs(title = "Bieu do the hien thu thap nhiem benh vao cac thang 03,06,07-2020 cua Chile",subtitle = "Theo trung binh 7 ngay gan nhat",y = "So ca nhiem benh",x = "Ngay",color = "Chu thich")+scale_x_discrete(breaks=c("10","20","31")) 
ggplot(chile_Made_2021,(aes(x = dates, y = new_cases_tb))) + geom_line(aes(color = month),group=1) +facet_wrap( ~ month)  +labs(title = "Bieu do the hien thu thap nhiem benh vao cac thang 01,03,06,07-2021 cua Chile",subtitle = "Theo trung binh 7 ngay gan nhat",y = "So ca nhiem benh",x = "Ngay",color = "Chu thich")+scale_x_discrete(breaks=c("10","20","31")) 
ggplot(chile_Made_2022,(aes(x = dates, y = new_cases_tb))) + geom_line(aes(color = month),group=1) +facet_wrap( ~ month)  +labs(title = "Bieu do the hien thu thap nhiem benh vao thang 01-2022 cua Chile",subtitle = "Theo trung binh 7 ngay gan nhat",y = "So ca nhiem benh",x = "Ngay",color = "Chu thich")+scale_x_discrete(breaks=c("10","20","31"))
...
library(ggplot2)
ggplot(venezuela_Made_2020,(aes(x = dates, y = new_cases_tb))) + geom_line(aes(color = month),group=1) +facet_wrap( ~ month)  +labs(title = "Bieu do the hien thu thap nhiem benh vao cac thang 03,06,07-2020 cua Venezuela",subtitle = "Theo trung binh 7 ngay gan nhat",y = "So ca nhiem benh",x = "Ngay",color = "Chu thich")+scale_x_discrete(breaks=c("10","20","31")) 
ggplot(venezuela_Made_2021,(aes(x = dates, y = new_cases_tb))) + geom_line(aes(color = month),group=1) +facet_wrap( ~ month)  +labs(title = "Bieu do the hien thu thap nhiem benh vao cac thang 01,03,06,07-2021 cua Venezuela",subtitle = "Theo trung binh 7 ngay gan nhat",y = "So ca nhiem benh",x = "Ngay",color = "Chu thich")+scale_x_discrete(breaks=c("10","20","31")) 
ggplot(venezuela_Made_2022,(aes(x = dates, y = new_cases_tb))) + geom_line(aes(color = month),group=1) +facet_wrap( ~ month)  +labs(title = "Bieu do the hien thu thap nhiem benh vao thang 01-2022 cua Venezuela",subtitle = "Theo trung binh 7 ngay gan nhat",y = "So ca nhiem benh",x = "Ngay",color = "Chu thich")+scale_x_discrete(breaks=c("10","20","31"))
